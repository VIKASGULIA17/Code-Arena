...
vector<vector<int>> makeAdj(vector<array<int,2>>& edges,int n){
            ...
            "square-decomposition-technique": {
                ...
                codeTemplates: {
                    "minimum-element-in-range": {
                        ...
                        videoLinks: ["https://youtu.be/gWbDocYhwDA?si=-uMYju3pVGRaUu8y","https://youtu.be/dfgfru9nXo?si=8s1l3m2a7j0qj5e"],
                        problemLinks: ["https://leetcode.com/"],
                        cpp: `#include <bits/stdc++.h>
using namespace std;
