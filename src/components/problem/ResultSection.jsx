    ...
    <div className="w-full mt-10 rounded-t-xl h-auto overflow-scroll shadow-2xl">
      ...
      <div className="py-4 px-4 bg-black/4 rounded-b-xl flex justify-between">
        <h2 className="px-7 font-semibold text-gray-600 pt-2">
          Showing <span>{startElement + 1}</span> to <span>{Math.min(lastElement, dsaProblems.length)}</span> of{" "}
        ...
        <div className="flex gap-3">
          ...
          {currentPage <=2 ? (
            ...
            <button className="border border-black/10 px-3 rounded-lg">...</button>
          )}
          <button
            onClick={() => {
              if (currentPage === 1) {
