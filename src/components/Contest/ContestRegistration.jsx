          ...
          <div className="w-full lg:w-[55%] p-8 lg:p-12 flex flex-col justify-between relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800/50">
                ...
                <span className="text-xs font-bold tracking-wide text-purple-600 dark:text-purple-300 uppercase">
                  Registration Open
                </span>
              </div>
            ...
            <motion.div variants={itemVariants} className="mb-10">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-xl">
                ...
                <span className="block mt-2 text-sm text-gray-500 dark:text-gray-500"></span>
              </p>
            </motion.div>
            ...
            >
              <div className="bg-gray-50 dark:bg-zinc-800/50 p-4 rounded-2xl border border-gray-100 dark:border-zinc-800 hover:border-purple-200 dark:hover:border-purple-900/50 transition-colors group">
                ...
                <p className="text-sm text-gray-500">{contest.startTime}</p>
              </div>
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-col sm:flex-row items-center gap-6 mt-auto"
            >
              {isRegistered ? (
                <Button
                  disabled
                  size="lg"
                  className="w-full sm:w-auto bg-linear-to-r from-emerald-500 to-emerald-600 opacity-90 border-0 text-white font-bold text-base px-8 py-6 rounded-xl shadow-lg drop-shadow-md cursor-not-allowed flex items-center justify-center lg:mt-0"
                >
              ...
              <div className="hidden sm:block">
                <p className="text-sm font-medium text-gray-500">
                  ...
                  <span className="text-gray-900 dark:text-white font-bold">
                    <Countdown targetTime={contest.startTime} />
                  </span>
                </p>
              </div>
            </motion.div>
          ...
          <div className="w-full lg:w-[45%] relative min-h-[400px] lg:min-h-full overflow-hidden group">
            ...
            >
              ...
              <p className="text-indigo-100 text-xs leading-relaxed">
                Our judging servers are online and ready. Prepare your
                environment for an optimal experience.
              </p>
            </motion.div>
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <motion.div
            ...
            className="bg-white dark:bg-zinc-900 rounded-3xl p-6 lg:p-8 max-w-md w-full shadow-2xl space-y-6"
          >
            ...
            <div className="flex gap-4 w-full pt-4">
              <Button
                variant="outline"
                className="w-1/2 py-6 rounded-xl border-gray-200 dark:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
                onClick={() => setShowConfirm(false)}
              >
                Cancel
              </Button>
              <Button
                className="w-1/2 py-6 rounded-xl bg-linear-to-r from-blue-600 to-purple-600 hover:opacity-90 text-white font-bold border-0 shadow-lg transition-transform hover:scale-[1.02]"
                onClick={() => {
