...
export const TREE_ALGORITHMS = {
  ...
  preorder: {
    ...
    space: "O(h)",
    description:
      "Root → Left → Right. Useful for tree serialization / copying.",
    color: "#10b981",
    needsInput: false,
  },
  postorder: {
    ...
    space: "O(h)",
    description:
      "Left → Right → Root. Used for safe deletion of subtrees.",
    color: "#f59e0b",
    needsInput: false,
  },
  levelorder: {
    ...
    space: "O(n)",
    description:
      "Breadth-first, level by level. Explores all nodes at depth d before d+1.",
    color: "#ec4899",
    needsInput: false,
  },
  insert: {
    ...
    space: "O(1)",
    description:
      "Navigates the BST to find the correct leaf position and inserts a new node.",
    color: "#0ea5e9",
    needsInput: true,
  },
  search: {
    ...
    space: "O(1)",
    description:
      "Binary search down the tree — go left if smaller, right if larger.",
    color: "#a855f7",
    needsInput: true,
  },
};
