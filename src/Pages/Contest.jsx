        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-[300px] shrink-0 space-y-6">
            ...
            <div className="card-elevated p-5 space-y-4">
              ...
              <Button variant="outline" className="w-full rounded-xl text-sm font-medium h-9 border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-all duration-200">
                View Full History
