...
const Signup = () => {
  ...
  const saveToSpringboot = async (values) => {
    const res = await axios.get(`${BACKEND_URL}/public/health-check`);
    console.log(res);
    return 1;
  };
  ...
  return (
    <div>
      <Navbar />
      <div
        className={`w-full h-screen  absolute top-10 left-0 duration-1000   bg-white/50 z-20`}
      >
        <div
          ...
          <div className="w-full h-full ">
            ...
            <svg
              ...
              className="hidden lg:block absolute 
                            top-33 left-[265px] h-[95px] rotate-[7deg]"
            >
              <path
                fill="#1e1e27"
                ...
                {({ isSubmitting }) => {
                  return (
                    ...
                    >
                      ...
                      <button
                        className=" w-[80%] bg-cardbg text-black border border-primary px-5 py-5 flex gap-2 mx-10"
                        type="button"
                      >
                        <input
                          type="checkbox"
                      ...
                      <p className="w-full text-center text-sm text-primary">
                        ...
                        <span className="text-black hover:underline">ToS,</span>{" "}
