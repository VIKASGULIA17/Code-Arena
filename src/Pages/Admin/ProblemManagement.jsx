              ...
              >
                ...
                <div className="bg-red-50 dark:bg-red-500/10 border-b border-red-100 dark:border-red-500/20 px-6 py-5 flex items-start gap-4">
                  ...
                  <button
                    ...
                    className="p-1.5 cursor-pointer rounded-lg text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors shrink-0"
                  >
                    <X size={18} />
                  </button>
                </div>
              ...
              <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] shadow-2xl flex flex-col overflow-hidden">
                <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-gray-50">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-white dark:hover:bg-slate-700 rounded-full transition-colors text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200 shadow-sm"
                  >
                    <X size={24} />
                  </button>
                </div>
                ...
                >
                  {({ values }) => (
                    <Form className="flex flex-col flex-1 overflow-hidden">
                      ...
                      <div className="p-6 pb-0 bg-white dark:bg-slate-800">
                        <FormGroup
                          label="Problem Title"
                          name="title"
                      ...
                      {/* Tabs */}
                      <div className="flex border-b border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 sticky top-0 z-10">
                        {tabs.map((tab) => (
                          <button
                            key={tab.id}
                            type="button"
