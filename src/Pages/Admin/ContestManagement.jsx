...
const ContestManagement = () => {
  ...
  const sendToSpringboot = async () => {
    try {
      console.log(`${BACKEND_URL}/contest/createContest`);
  ...
  const handleSave = (e) => {
    ...
    if (modalMode === "create") {
      ...
      setContests(
        contests.map((c) =>
          c.id === currentContest.id ? { ...c, ...currentContest } : c,
        ),
      );
    }
    setIsModalOpen(false);
